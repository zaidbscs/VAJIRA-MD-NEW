...
global.owner = process.env.OWNER_NUMBER  || '923357433862' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=TRsFkYQC#45wd0N6bjDMb-4Aq_Ng-UF6Q09ms1C47alin6OP-N1c' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923357433862" : process.env.MODERATORS ,    
